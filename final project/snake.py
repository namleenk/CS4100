...
#         self.dirnx = 0
#         self.dirny = 1
#         self.food = cube(randomSnack(rows, self), color=color)
...
#         # might need to break apart the horizontal and vertical movements
...
# # show snake taking the actions produced by the search algorithms
# def visualize_search(self, actions):
